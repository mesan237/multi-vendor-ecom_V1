...
export function NavbarDefault({ user }) {
  ...
  return (
    <Navbar className="sticky top-0 z-10 h-max max-w-full rounded-none px-4 py-2 lg:px-8 lg:py-4 dark:bg-components-dark dark:text-white dark:border-none shadow-none">
      <div className="flex items-center justify-between text-blue-gray-900">
        <Typography
          as="a"
          href="#"
          variant="h4"
          className="mr-4 cursor-pointer py-1.5 font-bold dark:text-white"
        >
          NZ-Furniture
        </Typography>
        <div className="flex items-center gap-4">
          ...
          <IconButton variant="text">
            <Badge content="5">
              <ChatBubbleBottomCenterIcon className="h-6 w-6 dark:text-white" />
            </Badge>
          </IconButton>
          <IconButton variant="text">
            <Switcher />
